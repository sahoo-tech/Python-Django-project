...
SECRET_KEY = 'django-insecure-replace-this-in-production-with-secure-key-2025'
...
mysql_name = os.environ.get('MYSQL_NAME') or os.environ.get('DB_NAME', 'healthcare_db')
mysql_host = os.environ.get('MYSQL_HOST') or os.environ.get('DB_HOST', 'localhost')
mysql_port = os.environ.get('MYSQL_PORT') or os.environ.get('DB_PORT', '3306')
